...
DASHBOARD_SECRET_KEY and the salt below must be identical across TheHost,
TheCodex, EcomBackend, and ImperialReminder so cookies set by one service
validate on the others (shared cross-subdomain login).
"""
