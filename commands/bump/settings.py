...
from storage.sub_systems.bump_config import BUMP_BOTS, BUMP_BOTS_PREMIUM, BUMP_BOTS_CHOICES
from utils.logger import get_logger

logger = get_logger("SSettingsView")

def create_settings_embed(config) -> Embed:
...
class DelaySelect(Select):
    ...
    async def callback(self, interaction: Interaction):
        ...
        try:
            await self.parent_view.bot.guild_config_manager.set_value(
