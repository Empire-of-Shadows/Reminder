...
Deliberately NOT behind ``setup_gatekeeper.check_or_notify``: this bot's help is
what explains how to finish setup, so it has to work on an unconfigured guild.
"""
...
class ReminderHelpView(ui.LayoutView):
...
class HelpCommands(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        try:
            ...
            view = ReminderHelpView(self.bot, is_admin)
