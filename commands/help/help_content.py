...
ADMIN = HelpCategory(
    ...
    body=(
        ...
        "message on/off\n"
        "\N{BULLET} **Panel Access** - which roles may open this panel and use the dashboard\n"
        ...
        "Anyone with Manage Server, plus any role added under Panel Access. Mod roles get "
